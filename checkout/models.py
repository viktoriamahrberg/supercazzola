...
class Order(models.Model):
    ...
    optional_address = models.CharField(max_length=80, null=True, blank=True)
    ...
    def update_total(self):
        """
        Updates the total order cost each time a new line is added.
